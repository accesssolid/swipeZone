            ...
            <Pressable onPress={props.onOutsidePress} style={styles.modalScreen}>
                <Pressable style={styles.modalContanier}>
                   <Pressable style={{ position: "absolute", right: 10, top: 10 }} onPress={props.onOutsidePress} >
                    ...
                    <FastImage source={images.Deactivate} style={{ height: 120, width: 120, alignSelf: 'center' }} />
                    <Text style={{ textAlign: 'center', marginTop: 16, fontFamily: AppFonts.Bold, fontSize: 20, color: colors.text }}>{ appkeys.DeactivateAccount}</Text>
                    <Text style={{ textAlign: 'center', marginTop: 12, fontFamily: AppFonts.Regular, fontSize: 14, color: colors.text }}>{appkeys.Deactivateconfirm}</Text>
