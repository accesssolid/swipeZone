        ...
        <Modal
            ...
            <Pressable onPress={props.onOutsidePress} style={styles.modalScreen}>
                <Pressable style={styles.modalContanier}>
                    ...
                    <Text style={{ textAlign: 'center', marginTop: 20, fontFamily: AppFonts.Bold, fontSize: 16, color: colors.text }}>Are you certain{"\n"}<Text style={{ fontFamily: AppFonts.Medium, fontSize: 14 }}>you wish to remove the match with this user?</Text></Text>
